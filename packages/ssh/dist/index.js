...
async function handleProfileAction(params) {
    switch (params.action) {
        ...
        case "set_default": {
            ...
            return {
                content: [{ type: "text", text: `Default SSH target set to ${state.defaultTarget}.` }],
                structuredContent: state,
            };
        }
        case "clear_default": {
            ...
            return {
                content: [{ type: "text", text: "Default SSH target cleared. Future calls must pass target explicitly." }],
                structuredContent: state,
            };
        }
        case "test": {
        ...
        case "upsert_device": {
            ...
            return {
                content: [{ type: "text", text: `SSH device ${device.name} saved.` }],
                structuredContent: { device },
            };
        }
        case "remove_device": {
            ...
            return {
                content: [{ type: "text", text: `SSH device ${name} removed.` }],
                structuredContent: state,
            };
        }
        default:
